...
class Percent40 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      debugShowCheckedModeBanner: false,
      home: new Percent40page(),
    );
  }
}

class Percent40page extends StatefulWidget {
  Percent40page({Key key, this.title}) : super(key: key);
...
class _MyHomePageState extends State<Percent40page> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: ListPage(),
...
class _ListPageState extends State<ListPage> {
  Future getPosts() async {
    ...
    QuerySnapshot qn = await firestore.collection('percent 40').getDocuments();
