...
class Percent50 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      debugShowCheckedModeBanner: false,
      home: new Percent50page(),
    );
  }
}

class Percent50page extends StatefulWidget {
  Percent50page({Key key, this.title}) : super(key: key);
...
class _MyHomePageState extends State<Percent50page> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: ListPage(),
...
class _ListPageState extends State<ListPage> {
  Future getPosts() async {
    ...
    QuerySnapshot qn = await firestore.collection('percent50').getDocuments();
