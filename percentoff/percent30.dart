...
class Percent30 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      debugShowCheckedModeBanner: false,
      home: new Percent30page(),
    );
  }
}

class Percent30page extends StatefulWidget {
  Percent30page({Key key, this.title}) : super(key: key);
...
class _MyHomePageState extends State<Percent30page> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: ListPage(),
...
class _ListPageState extends State<ListPage> {
  Future getPosts() async {
    ...
    QuerySnapshot qn = await firestore.collection('percent30').getDocuments();
