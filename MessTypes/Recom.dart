...
class Recompage extends StatefulWidget {
  Recompage({Key key, this.title}) : super(key: key);
...
class _MyHomePageState extends State<Recompage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Recomlist(),
...
class Recomlist extends StatefulWidget {
  @override
  _ListPageState createState() => _ListPageState();
}

class _ListPageState extends State<Recomlist> {
      ...
      child: FutureBuilder(
        ...
        builder: (_, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            return Center(
                child: new SpinKitThreeBounce(color: Colors.tealAccent,));
          } else {
