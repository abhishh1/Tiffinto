...
class Newlyopen extends StatelessWidget {
  @override
...
class _ListPageState extends State<ListPage> {
  Future getPosts() async {
    ...
    QuerySnapshot qn = await firestore.collection('NewlyOpened').getDocuments();
      ...
      child: FutureBuilder(
        ...
        builder: (_, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            return Center(
                child: new SpinKitThreeBounce(color: Colors.greenAccent,));
          } else {
                  ...
                  SafeArea(
                    child: Card(
                     child: ListTile(
                       ...
                       title: Text('Available',style: TextStyle(fontFamily: 'Prestage',fontSize: 16.0),),
                     ),
                    ),
                  ),
                  SafeArea(
