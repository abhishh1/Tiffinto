...
class SpecialSweets extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      debugShowCheckedModeBanner: false,
      home: new SpecialPageSweets(),
    );
  }
}

class SpecialPageSweets extends StatefulWidget {
  SpecialPageSweets({Key key, this.title}) : super(key: key);
...
class _MyHomePageState extends State<SpecialPageSweets> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: ListPage(),
...
class _ListPageState extends State<ListPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        leading: Image.asset('assets/sweets.jpg'),
                                    ...
                                    Container(
                                      decoration: BoxDecoration(
                                          ...
                                          image: DecorationImage(
                                            image: AssetImage('assets/list8.jpg'),
                                            fit: BoxFit.cover
                                          )),
                                      child: new ListTile(
