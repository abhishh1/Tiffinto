...
class SpecialRice extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      debugShowCheckedModeBanner: false,
      home: new SpecialPageRice(),
    );
  }
}

class SpecialPageRice extends StatefulWidget {
  SpecialPageRice({Key key, this.title}) : super(key: key);
...
class _MyHomePageState extends State<SpecialPageRice> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: ListPage(),
...
class _ListPageState extends State<ListPage> {
  Future getPosts() async {
    ...
    QuerySnapshot qn = await firestore.collection('Specials').getDocuments();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        leading: Image.asset('assets/rice.jpg'),
        backgroundColor: Colors.white,
        title: Text(
          "Rice",
          style: TextStyle(
              fontFamily: 'Prestage', fontSize: 30.0, color: Colors.black),
        ),
        centerTitle: true,
      ),
      body: FutureBuilder(
        ...
        builder: (_, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            return Center(child: new SpinKitCircle(color: Colors.red));
          } else {
      ...
      bottomNavigationBar: BottomAppBar(
          child: FlatButton(
              ...
              onPressed: () {
                SnackBarAction(label: 'Check for more', onPressed: () {});
              })),
    );
  }
}
