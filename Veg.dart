...
import 'package:app4/ui/image.dart';
...
class VegPage extends StatefulWidget {
  VegPage({Key key, this.title}) : super(key: key);
...
class _MyHomePageState extends State<VegPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: ListPage(),
...
class _ListPageState extends State<ListPage> {
  Future getPosts() async {
    ...
    QuerySnapshot qn = await firestore.collection('Veg').getDocuments();
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          "Veg stuff",
          style: TextStyle(
              fontFamily: 'Prestage', fontSize: 26.0, color: Colors.black),
        ),
        centerTitle: true,
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.of(context)
                .push(MaterialPageRoute(builder: (context) => trial()));
          },
          color: Colors.black,
        ),
      ),
      ...
      bottomNavigationBar: BottomAppBar(
        ...
        onPressed: () {
          Scaffold.of(context).showSnackBar(SnackBar(
              ...
              content: Card(
                child: ListTile(
                  leading: Image.asset('assets/chef.png'),
                  title: Text(
                    'Swipe down to see more',
                    style: TextStyle(fontFamily: 'Soda', fontSize: 20.0),
...
class _DetailPageState extends State<DetailPage> {
    ...
    showModalBottomSheet(
        ...
        builder: (context) {
          return Container(
              decoration: BoxDecoration(
                  image: DecorationImage(
                      image: AssetImage('assets/new3.jpg'), fit: BoxFit.fill)),
              height: 70.0,
              child: Center(
                child: SizedBox(
                  height: 80.0,
  ...
  void locationMap() {
    showCupertinoModalPopup(
        context: context,
        builder: (context) {
          return Container(height: 1000.0, child: GeoMap());
        });
  }
...
//===============================================================================================================================
                  ...
                  SafeArea(
                    ...
                    title: const Text('Select the mess?',style: TextStyle(fontFamily: 'Prestage'),),
                    value: _lights,
                  ...
                  Container(
                      child: SizedBox(height: 250.0, child: ImageSreen())),
                  SizedBox(
                    height: 50.0,
                    child: Row(
                      children: <Widget>[
