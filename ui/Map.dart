...
class _GeoMapState extends State<GeoMap> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      floatingActionButton: FloatingActionButton(backgroundColor: Colors.white,
        child: Icon(EvaIcons.homeOutline,color: Colors.redAccent,),
        onPressed: (){Navigator.push(context, PageTransition(child: trial(),type: PageTransitionType.leftToRightWithFade));},),
      body: mapWidget());
  }
  ...
  void initMarker(request, requestID) {
    ...
    final Marker marker = Marker(
      ...
      infoWindow: InfoWindow(title: 'Tiffinto', snippet: request['name']),
    );
    setState(() {
