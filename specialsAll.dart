...
class SpecialAll extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      debugShowCheckedModeBanner: false,
      home: new SpecialPageAll(),
    );
  }
}

class SpecialPageAll extends StatefulWidget {
  SpecialPageAll({Key key, this.title}) : super(key: key);
...
class _MyHomePageState extends State<SpecialPageAll> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: ListPage(),
      ...
      body: FutureBuilder(
        ...
        builder: (_, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            return Center(child: new SpinKitDualRing(color: Colors.red));
          } else {
